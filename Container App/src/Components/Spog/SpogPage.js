...
const SpogPage = () => (
  <main id="spog">
    <h2>This will definitely be a different service but I didn't want to serve the dash on /</h2>
    <p>
      Many thanks to {' '}
      <a href="https://twitter.com/thecamjackson">Cam Jackson</a> to demonstrate
      just one way that micro frontends can be implemented and I used this project to scaffold this
    </p>
    <p>
      Many more thanks to {' '}
      <a href="https://medium.com/@jenniferfubook">Jennifer Fu</a> for writing an article on not changing the web config & supporting chunked repos
    </p>
    <p>
    ...
    <p>
      All Developers please read more about the technique, including a full explanation of how the
