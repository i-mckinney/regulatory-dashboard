...
export const columnExcludes = ["Password", "MiddleName", "Address1", "Address2", "City", "State", "Country", "Zipcode"]

// columnFields is array of fields that UserForm will have 
export const columnFields = ["Username", "Password", "FirstName", "MiddleName", "LastName", "Address1", "Address2", "City", "State", "Country", "Zipcode", "DateOfBirth", "Role"]
...
// (3) Actions
export const columnLabels = ["_id","Username", "Password", "First Name", "Middle Name", "Last Name", "Address1", "Address2", "City", "State", "Country", "Zip Code", "Date Of Birth", "Role", "User Created", "User Updated", "Actions"]
