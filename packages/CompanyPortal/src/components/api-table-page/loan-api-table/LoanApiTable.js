 ...
 * @return {JSX} LoanApiTable of the client's custom APIs
 * routed at /
 */
const LoanApiTable = (props) => {
   ...
   * It will fetchUsers whenever LoanApiTable loads
   */
  useEffect(() => {
...
export default withRouter(LoanApiTable)
