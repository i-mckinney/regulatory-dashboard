 ...
 * @return {JSX} EntityApiTable of the client's custom APIs
 * routed at /
 */
const EntityApiTable = (props) => {
   ...
   * It will fetchUsers whenever EntityApiTable loads
   */
  useEffect(() => {
...
export default withRouter(EntityApiTable)
