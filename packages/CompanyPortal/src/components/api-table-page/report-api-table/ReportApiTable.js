 ...
 * @return {JSX} ReportApiTable of the client's custom APIs
 * routed at /
 */
const ReportApiTable = (props) => {
   ...
   * It will fetchUsers whenever ReportApiTable loads
   */
  useEffect(() => {
...
export default withRouter(ReportApiTable)
