...
1. Create your front end design and code using standards above
2. Create a js file that will host mock data to populate your data on the front end (create this file in same folder as your component you wish to prefill)
3. Get data structure approved with team
4. Eventually we will use that structure to create a backend to hook into and use that structure so there is not so much initial communication and back and forth
