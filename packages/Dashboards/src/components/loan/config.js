...
export const columnFields = ["loanName", "loanType", "commitmentAmount", "maturityDate"]
...
// (3) Actions
export const columnLabels = ["_id", "Loan Name", "Loan Type", "Commitment Amount", "Maturity Date", "Actions"]
