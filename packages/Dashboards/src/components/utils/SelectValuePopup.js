...
import AddMissingKey from './AddMissingKey';
    ...
    <div>
      ...
      >
        <div className={classes.header}>
          <Typography className={classes.typography}>{title}</Typography>
           <Grid container spacing ={1} className= {classes.headerGrid}>
            ...
            <Grid item xs={7}>
              <AddMissingKey addKey = {addCollectionKey} />
            </Grid> 
          </Grid>
        </div>
        <RadioGroup
        ...
        <div className={classes.buttonGroup}> 
          <Button onClick={handleOk} color="primary" text="Ok"  size='small'/>
          <Button onClick={handleClose} color="default" text="Cancel" size='small' />
        </div>
      </Popover>
    </div>
  );
